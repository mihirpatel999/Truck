...
function Navbar() {
  ...
  return (
    <nav className="bg-gradient-to-r from-indigo-900 via-purple-900 to-indigo-900 backdrop-blur-md shadow-xl border-b border-white/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          <div className="flex items-center space-x-3 text-white font-bold text-xl">
            <img
            ...
            />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-400">Lemon ERP</span>
          </div>
          ...
          <div className="hidden md:flex space-x-8 items-center font-medium text-white">
            {(canAccess('plantmaster') || canAccess('usermaster') || canAccess('userregister')) && (
              <div className="relative group">
                <button
                  ...
                  className="hover:text-yellow-300 flex items-center transition-all duration-300 hover:scale-105"
                >
                  Admin Master <span className="ml-1 text-sm">▼</span>
                </button>
                <div className={`absolute top-full left-0 mt-2 w-56 bg-black/80 backdrop-blur-md rounded-lg shadow-xl z-50 ${adminOpen ? 'block' : 'hidden'} transform opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-200 ease-out`}>
                  {canAccess('plantmaster') && (
                    <NavLink to="/plantmaster">
                      <span className="block px-4 py-2 text-white hover:bg-gradient-to-r from-blue-600 to-purple-600 rounded-t">🏭 Plant Master</span>
                    </NavLink>
                  )}
                  {canAccess('usermaster') && (
                    <NavLink to="/usermaster">
                      <span className="block px-4 py-2 text-white hover:bg-gradient-to-r from-blue-600 to-purple-600">👤 User Master</span>
                    </NavLink>
                  )}
                  {canAccess('userregister') && (
                    <NavLink to="/userregister">
                      <span className="block px-4 py-2 text-white hover:bg-gradient-to-r from-blue-600 to-purple-600 rounded-b">📝 User Register</span>
                    </NavLink>
                  )}
                </div>
              </div>
            ...
            {(canAccess('truck') || canAccess('truckfind')) && (
              <div className="relative group">
                ...
                <div className={`absolute top-full left-0 mt-2 w-56 bg-black/80 backdrop-blur-md rounded-lg shadow-xl z-50 ${dispatcherOpen ? 'block' : 'hidden'} transform opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-200 ease-out`}>
                  {canAccess('truck') && (
                    <NavLink to="/truck">
                      <span className="block px-4 py-2 text-white hover:bg-gradient-to-r from-blue-600 to-purple-600 rounded-t">🚛 Truck Transaction</span>
                    </NavLink>
                  )}
                  {canAccess('truckfind') && (
                    <NavLink to="/truckfind">
                      <span className="block px-4 py-2 text-white hover:bg-gradient-to-r from-blue-600 to-purple-600 rounded-b">🔍 Truck Find</span>
                    </NavLink>
                  )}
                </div>
              </div>
            ...
            {canAccess('gate') && (
              <NavLink to="/gate">
                <span className="text-white hover:text-yellow-300 flex items-center transition-all duration-300 hover:scale-105">🚪 Gate Keeper</span>
              </NavLink>
            )}

            {canAccess('loader') && (
              <NavLink to="/loader">
                <span className="text-white hover:text-yellow-300 flex items-center transition-all duration-300 hover:scale-105">📦 Loader</span>
              </NavLink>
            )}
            ...
            {(canAccess('reports') || canAccess('truckshedule')) && (
              <div className="relative group">
                ...
                <div className={`absolute top-full left-0 mt-2 w-56 bg-black/80 backdrop-blur-md rounded-lg shadow-xl z-50 ${reportsOpen ? 'block' : 'hidden'} transform opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-200 ease-out`}>
                  {canAccess('reports') && (
                    <NavLink to="/reports">
                      <span className="block px-4 py-2 text-white hover:bg-gradient-to-r from-blue-600 to-purple-600 rounded-t">📈 Reports</span>
                    </NavLink>
                  )}
                  {canAccess('truckshedule') && (
                    <NavLink to="/truckshedule">
                      <span className="block px-4 py-2 text-white hover:bg-gradient-to-r from-blue-600 to-purple-600 rounded-b">🚛 Truck Schedule</span>
                    </NavLink>
                  )}
                </div>
              </div>
            ...
            <button
              onClick={handleLogout}
              className="ml-4 px-5 py-2 bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white font-semibold rounded-full shadow-lg border border-red-700 transition-transform duration-300 hover:scale-105 focus:outline-none"
            >
              🔓 Logout
            </button>
          </div>
          ...
          <div className="md:hidden">
            <button
              onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
              className="text-white hover:text-yellow-300 text-2xl transition-all duration-300 hover:scale-110 focus:outline-none"
            >
              ☰
            </button>
          </div>
        ...
        {/* Mobile Menu Panel */}
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 grid grid-cols-2 gap-4 bg-black/80 p-4 backdrop-blur-md rounded-2xl shadow-2xl text-white font-medium animate-fadeIn">
            {canAccess('plantmaster') && (
              <NavLink to="/plantmaster">
                <div className="bg-gray-800/70 hover:bg-gradient-to-br from-blue-600 to-purple-700 p-4 rounded-xl flex flex-col items-center justify-center shadow-lg transition-transform duration-300 hover:scale-105">
                  🏭 <span className="mt-2">Plant Master</span>
                </div>
              </NavLink>
            )}
            ...
            <button
              onClick={handleLogout}
              className="col-span-2 mt-2 bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white py-3 rounded-xl shadow-lg transition-transform duration-300 hover:scale-105"
            >
              🔓 Logout
            </button>
          </div>
