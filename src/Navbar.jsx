...
//         {/* Mobile Menu Grid Fixed 2-column Layout */}
//         {mobileMenuOpen && (
//           <div className="md:hidden mt-4 grid grid-cols-2 gap-4 bg-gray-900 p-4 rounded-xl shadow-2xl text-white font-medium">
//             {canAccess('plantmaster') && (
//               <NavLink to="/plantmaster">
//                 <div className="bg-gray-800 hover:bg-blue-600 p-4 rounded-xl flex flex-col items-center justify-center shadow-lg h-32">
//                   🏭 <span className="mt-2">Plant Master</span>
//                 </div>
//               </NavLink>
//             )}
  ...
  return (
    <nav className="bg-black shadow-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Menu Grid Fixed Layout */}
        {mobileMenuOpen && (
          <div className="md:hidden min-h-screen flex flex-col items-center mt-4">
            <div className="grid grid-cols-2 gap-4 w-[90%] max-w-md">
              {canAccess('plantmaster') && (
                <NavLink to="/plantmaster">
                  <div className="bg-white hover:bg-blue-100 p-4 rounded-xl flex flex-col items-center justify-center shadow-lg h-32">
                    🏭 <span className="mt-2 text-black font-medium">Plant Master</span>
                  </div>
                </NavLink>
              )}
              {canAccess('usermaster') && (
                <NavLink to="/usermaster">
                  <div className="bg-white hover:bg-blue-100 p-4 rounded-xl flex flex-col items-center justify-center shadow-lg h-32">
                    👤 <span className="mt-2 text-black font-medium">User Master</span>
                  </div>
                </NavLink>
              )}
              {canAccess('userregister') && (
                <NavLink to="/userregister">
                  <div className="bg-white hover:bg-blue-100 p-4 rounded-xl flex flex-col items-center justify-center shadow-lg h-32">
                    📝 <span className="mt-2 text-black font-medium">User Register</span>
                  </div>
                </NavLink>
              )}
              {canAccess('truck') && (
                <NavLink to="/truck">
                  <div className="bg-white hover:bg-blue-100 p-4 rounded-xl flex flex-col items-center justify-center shadow-lg h-32">
                    🚛 <span className="mt-2 text-black font-medium">Truck Transaction</span>
                  </div>
                </NavLink>
              )}
              {canAccess('truckfind') && (
                <NavLink to="/truckfind">
                  <div className="bg-white hover:bg-blue-100 p-4 rounded-xl flex flex-col items-center justify-center shadow-lg h-32">
                    🔍 <span className="mt-2 text-black font-medium">Truck Find</span>
                  </div>
                </NavLink>
              )}
              {canAccess('gate') && (
                <NavLink to="/gate">
                  <div className="bg-white hover:bg-blue-100 p-4 rounded-xl flex flex-col items-center justify-center shadow-lg h-32">
                    🚪 <span className="mt-2 text-black font-medium">Gate Keeper</span>
                  </div>
                </NavLink>
              )}
              {canAccess('loader') && (
                <NavLink to="/loader">
                  <div className="bg-white hover:bg-blue-100 p-4 rounded-xl flex flex-col items-center justify-center shadow-lg h-32">
                    🛆 <span className="mt-2 text-black font-medium">Loader</span>
                  </div>
                </NavLink>
              )}
              {canAccess('reports') && (
                <NavLink to="/reports">
                  <div className="bg-white hover:bg-blue-100 p-4 rounded-xl flex flex-col items-center justify-center shadow-lg h-32">
                    📈 <span className="mt-2 text-black font-medium">Reports</span>
                  </div>
                </NavLink>
              )}
              {canAccess('truckshedule') && (
                <NavLink to="/truckshedule">
                  <div className="bg-white hover:bg-blue-100 p-4 rounded-xl flex flex-col items-center justify-center shadow-lg h-32">
                    🚛 <span className="mt-2 text-black font-medium">Truck Schedule</span>
                  </div>
                </NavLink>
              )}
            </div>
            ...
            <button
              onClick={handleLogout}
              className="w-[90%] max-w-md mt-6 bg-red-600 hover:bg-red-700 text-white py-3 rounded-xl shadow-lg"
            >
              🔓 Logout
            </button>
          </div>
