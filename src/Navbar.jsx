        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/dashboard" className="flex-shrink-0 flex items-center">
              ...
              <span className="ml-3 text-xl font-semibold text-gray-900 hidden sm:block">Lemon Logistics</span>
            </Link>
                ...
                <div key={index} className="relative">
                  {item.path ? (
                    ...
                    >
                      ...
                      <div 
                        className={`absolute left-0 mt-1 w-56 rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 overflow-hidden transition-all duration-200 origin-top-right z-50 ${
          ...
          <div className="flex items-center">
            <button
              onClick={handleLogout}
              className="inline-flex items-center px-3 py-2 rounded-md text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors"
            >
              <FiLogOut className="mr-2" />
